...
(function () {
  ...
  angular.module('BlurAdmin.pages.analytics')
      .controller('AreaChartCtrlAnalytics1',AreaChartCtrlAnalytics1);

  /** @ngInject */
  function AreaChartCtrlAnalytics1($scope, baConfig, $element, layoutPaths) {
	console.log('AreaChartCtrlPlayer',$scope);
